...
const Button = ({ title, href }: ButtonProps) => {
  ...
  return (
    <Component
      ...
      className="relative w-fit px-4 py-2 md:px-6 md:py-3 lg:px-8 lg:py-4 text-sm md:text-base text-(--text-color-2) syne-normal ring-2 rounded-full cursor-pointer transition-all duration-300 ease-in-out
