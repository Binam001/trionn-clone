const CircularBrand = () => {
  return (
    ...
    <div className="circular-brand fixed right-10 bottom-10 size-20 lg:size-32 border border-[#4caf50] rounded-full p-1 lg:p-2 z-100 cursor-pointer mix-blend-screen">
      <svg
