...
export const ImageHover = ({
  ...
  const [lerpedPos, setLerpedPos] = useState<{ x: number; y: number } | null>(
    null
  );
    ...
    flex flex-col justify-center items-center text-outline-effect"
        ...
        {lerpedPos && radius > 0 && (
          <div
            ...
            style={{
              background: `radial-gradient(circle ${radius + 200}px at ${
                lerpedPos.x
              }px ${
                lerpedPos.y
              }px, rgba(255,255,255,0.13) 0, rgba(255,255,255,0.07) 60%, transparent 100%)`,
              mixBlendMode: "screen",
