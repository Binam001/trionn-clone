    ...
    <div className="mt-20 grid lg:grid-cols-2 gap-4">
      {progress.map((item) => (
        <div
          className={`${
            item.id === 1
              ? "bg-[#c93303] text-(--foreground)"
              : item.id === 2
              ? "bg-[#c8d2d2] text-(--background)"
              : item.id === 3
              ? "bg-[#a1c9b8] text-(--background)"
              : "bg-[#decf3e] text-(--background)"
          }
          lg:bg-(--card-bg) p-6 rounded-4xl ${
            item.id === 1
              ? "hover:bg-[#c93303]"
              : item.id === 2
              ? "hover:bg-[#c8d2d2] hover:text-(--background)"
              : item.id === 3
              ? "hover:bg-[#a1c9b8] hover:text-(--background)"
              : "hover:bg-[#decf3e] hover:text-(--background)"
        ...
        >
          ...
          <div className="text-[30px] lg:text-[40px] w-1/2 text-right justify-self-end font-[daysoftype] uppercase**[font-feature-settings:'ss01']**">
            {item.title}
          </div>
        </div>
      ))}
