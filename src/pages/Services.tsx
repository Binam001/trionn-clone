...
const Services = () => {
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      />
      <motion.div className="flex flex-col items-center gap-8 mt-10">
        <CircularBrand />
        <div
          id="servicePageTitle"
          ...
          <div className="mt-10 flex justify-end">
            <div className="text-(--text-color) font-[Poppins] md:w-1/2 space-y-4 lg:text-xl">
              <p className="servicePageText">
                ...
                digital prowess, we fearlessly overcome them. Bring your
                branding, web design, and creative challenges; our lionhearted
                approach will leave a lasting impression.
              </p>
            </div>
          </div>
        </div>
